---
title: 合作品牌
meta_title: "合作品牌 — Quedic"
description: "我們合作過的交易所、協議與消費級加密品牌 —— 以及承載他們故事的媒體發佈網絡。"
layout: default
permalink: /zh-tw/brands/
lang: zh-tw
...
<section class="page-header">
  <div class="container">
    <span class="page-header__eyebrow">合作品牌</span>
    <h1>我們合作過的品牌。</h1>
    <p class="lede">合作範圍涵蓋一線交易所、底層基礎設施、DeFi 與消費級加密項目 —— 透過品牌活動、新聞發佈、KOL 計劃與大型賽事協作交付。</p>
  </div>
</section>
...
<section class="section section--soft">
  <div class="container">
    <div class="section-title">
      <div>
        <span class="eyebrow eyebrow--brand">02 ／ 故事的落腳之處</span>
        <h2>媒體發佈網絡。</h2>
      </div>
      <div class="section-title__aside">
        涵蓋加密原生、金融科技與主流商業媒體的直接合作關係與發佈渠道 —— 以及能將您的新聞帶至數千家次級媒體的通訊社網絡。
      </div>
    </div>
    ...
    <div class="media-network">
      ...
      <p class="fine-print">
        上述為我們合作的發佈夥伴與觸達網絡內的媒體。最終刊載仍取決於內容新聞性、編輯適配度與市場時機。
      </p>
    </div>
  </div>
</section>
...
<section class="section section--tint">
  <div class="container container--narrow">
    <div class="contact-cta">
      <h2 class="contact-cta__title">將您的品牌加入名單。</h2>
      <p class="contact-cta__sub">告訴我們您正在打造什麼。</p>
      <div class="contact-cta__ctas">
        <a class="btn btn--primary" href="{{ '/zh-tw/contact/' | relative_url }}">預約策略諮詢</a>
      </div>
    </div>
  </div>
</section>
